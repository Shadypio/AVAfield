...
<section>
    ...
    <c:forEach items="${listaEventi}" var="evento" >
        ...
        <ul class="list-group" style="cursor: pointer" onclick="window.open('<%=request.getContextPath()%>/ge/partecipaAdEvento?idEvento=${evento.idEvento}', '_self');">
               <li class="list-group-item"><h5>${evento.nome}</h5>
                <h6>Partecipanti Max:${evento.numeroPartecipanti}</h6>
                <h6>Data: ${evento.dataEvento}</h6></li>
        </ul>
    </c:forEach>
</section>
</body>
